...
const ScholarBox = ({image, topText, bottomText}) => {
return(
            ...
            <div>
              ...
              />
                ...
                <Stack spacing={0}>
                  ...
                  <div style={{ wordWrap: 'normal' , lineHeight: 1.2, fontSize : "2vh", marginRight:"2vh",  marginBottom:"2vh", marginLeft:"2vh", marginTop: "0vh", fontWeight: '400', color: 'rgb(0, 158, 158)' }}> {bottomText}</div>
                </Stack>
              </Stack>
            </Box>
          </Box>
